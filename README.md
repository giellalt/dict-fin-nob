# Dictionary for fin — nob

This repository contains source files for a dictionary from Finnish to Norwegian Bokmål. The content is licensed under the CC-BY-4.0 license.
